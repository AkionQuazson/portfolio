export const projects = [
	{name:'Doomwood RPG', link:'https://spencer.hicken.com/games/doomwood', icon:'doomwood', technologies: ['HTML', 'CSS', 'Vanilla Javascript', 'Object-oriented programming'], description:'My first major web project through which I was self-taught web development. It is a turn-based RPG created with raw javascript, HTML, and CSS. The map is procedurally generated before you even step foot in the first room, unless you have a game previously stored in local storage.'},
